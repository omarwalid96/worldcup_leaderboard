...
export const metadata: Metadata = {
  ...
  appleWebApp: {
    ...
    title: "Eznii Ya Dawly",
    // iOS standalone launch images. MUST be emitted via metadata (not raw <head>
    // JSX) — raw <link> children of <head> in an App Router root layout get
    // duplicated into <body>, and iOS then matches no startup image → blank white
    // splash on every device. Next renders these once, in <head>.
    startupImage: [
      ...
      { url: "/splash/iphone-x-11pro-12mini.png", media: "(device-width: 375px) and (device-height: 812px) and (-webkit-device-pixel-ratio: 3) and (orientation: portrait)" },
      ...
      { url: "/splash/iphone-12-13-14-promax.png", media: "(device-width: 428px) and (device-height: 926px) and (-webkit-device-pixel-ratio: 3) and (orientation: portrait)" },
      { url: "/splash/iphone-393x852.png", media: "(device-width: 393px) and (device-height: 852px) and (-webkit-device-pixel-ratio: 3) and (orientation: portrait)" },
      { url: "/splash/iphone-14-15-promax.png", media: "(device-width: 430px) and (device-height: 932px) and (-webkit-device-pixel-ratio: 3) and (orientation: portrait)" },
      ...
      { url: "/splash/iphone-16-promax.png", media: "(device-width: 440px) and (device-height: 956px) and (-webkit-device-pixel-ratio: 3) and (orientation: portrait)" },
      { url: "/splash/ipad-10.png", media: "(device-width: 820px) and (device-height: 1180px) and (-webkit-device-pixel-ratio: 2) and (orientation: portrait)" },
  ...
  return (
    <html lang="en" className="dark" suppressHydrationWarning>
      <head>
        ...
        {/* Startup images live in metadata.appleWebApp.startupImage (above) so
            Next emits them once inside <head>. Raw <link> children here got
            duplicated into <body>, which iOS ignored → blank white splash. */}
      </head>
      <body
